        ...
        return (
            <div className="relative">
                <input
                    ref={ref}
                    type={inputType}
                    className={`h-9 w-full ${readonlyStyles} ${isPassword ? "pr-10" : ""} rounded-lg border border-main-700 bg-main-800 px-3 text-sm text-main-100 outline-none transition-colors duration-200 placeholder:text-main-500 focus-visible:border-main-500/70 focus-visible:ring-2 focus-visible:ring-main-500/25 ${className}`}
                    {...props}
                />
                {isPassword && (
                    <Icon
